...
namespace ViewModel
{
    public class CustomerDB : BaseDB
    {
        ...
        {
            string sql = $"INSERT INTO Customer(CustomerName, CustomerPhone, CustomerEmail, CustomerAddress, CustomerPassword, CustomerPFP)" + 
                $" VALUES('{customer.CustomerName}','{customer.CustomerPhone}','{customer.CustomerEmail}','{customer.CustomerAddress}','{customer.CustomerPassword}','{customer.CustomerPFP}')";
        ...
        public int Update(Customer customer)
        {
            string sql = $"Update Customer SET CustomerName='{customer.CustomerName}', CustomerPhone='{customer.CustomerPhone}', CustomerEmail='{customer.CustomerEmail}'," +
                $" CustomerAddress='{customer.CustomerAddress}', CustomerPassword='{customer.CustomerPassword}', CustomerPFP='{customer.CustomerPFP}' WHERE CustomerID={customer.CustomerID}";
